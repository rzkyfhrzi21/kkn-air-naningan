...
<div class="flex flex-col w-full px-container-pad-mobile md:px-container-pad-desktop py-8 md:py-12 gap-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-line pb-6">
        <div class="flex flex-col gap-2">
            ...
            <p class="font-body-md text-body-md text-on-surface-variant max-w-2xl">Kelola dan balas pertanyaan, masukan, atau keluhan dari masyarakat yang dikirim melalui formulir kontak.</p>
        </div>
    ...
    <div class="flex flex-col lg:flex-row gap-6" style="min-height: 600px; height: calc(100vh - 280px);">
        ...
        <div class="w-full lg:w-[400px] xl:w-[450px] flex flex-col bg-surface rounded-xl border border-line overflow-hidden shadow-sm shrink-0">
            <div class="p-4 border-b border-line flex items-center justify-between bg-surface-container-lowest">
                <div class="relative w-full">
                    ...
                    <input class="w-full bg-surface-container text-ink font-body-md text-[14px] rounded-lg pl-10 pr-4 py-2.5 outline-none focus:ring-1 focus:ring-primary/50 transition-all border border-transparent focus:border-line placeholder:text-on-surface-variant/50" placeholder="Cari pesan..." type="text"/>
                </div>
            </div>
            <div class="flex-1 overflow-y-auto" id="message-list">
                ...
                <button class="w-full text-left p-4 border-l-4 border-transparent hover:bg-surface-container-low transition-colors group flex flex-col gap-2 relative border-b border-line">
                    ...
                    <span class="font-body-md text-[14px] text-on-surface-variant/70 truncate w-full">Laporan Infrastruktur Jalan Rusak di Dusun 3</span>
                ...
                <button class="w-full text-left p-4 border-l-4 border-transparent hover:bg-surface-container-low transition-colors group flex flex-col gap-2 relative border-b border-line">
                    ...
                    <span class="font-body-md text-[14px] text-on-surface-variant/70 truncate w-full">Undangan Kolaborasi Festival Kopi</span>
                ...
                <button class="w-full text-left p-4 border-l-4 border-transparent hover:bg-surface-container-low transition-colors group flex flex-col gap-2 relative border-b border-line">
                    ...
                    <span class="font-body-md text-[14px] text-on-surface-variant/70 truncate w-full">Kendala Registrasi UMKM</span>
        ...
        <!-- Detail Pesan -->
        <div class="flex-1 bg-surface-2 rounded-xl border border-line flex flex-col overflow-hidden shadow-md">
            <div class="p-6 border-b border-line/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-surface-container-lowest/50 backdrop-blur-sm sticky top-0 z-10">
                <div class="flex items-start gap-4">
                    <div class="w-12 h-12 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center font-h3 text-xl shrink-0 uppercase">BS</div>
                ...
                <div class="flex items-center gap-2 shrink-0">
                    <button aria-label="Tandai belum dibaca" class="p-2 rounded-full hover:bg-surface-container text-on-surface-variant hover:text-primary transition-colors"><span class="material-symbols-outlined text-[22px]">mark_as_unread</span></button>
                    <button aria-label="Arsipkan" class="p-2 rounded-full hover:bg-surface-container text-on-surface-variant hover:text-ink transition-colors"><span class="material-symbols-outlined text-[22px]">archive</span></button>
                    <button aria-label="Hapus" class="p-2 rounded-full hover:bg-error-container/20 text-on-surface-variant hover:text-error transition-colors"><span class="material-symbols-outlined text-[22px]">delete</span></button>
                </div>
            </div>
            <div class="flex-1 overflow-y-auto p-6 md:p-8">
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="font-body-lg text-on-surface-variant space-y-6 leading-relaxed">
                        ...
                        <p>Saya ingin menanyakan beberapa hal terkait operasional wisata:</p>
                        <ul class="list-disc pl-5 space-y-2 marker:text-primary/50">
                            ...
                            <li>Apakah jalan menuju ke lokasi sudah bisa dilalui mobil MPV biasa?</li>
                        </ul>
                        <p>Mohon informasinya agar kami bisa mempersiapkan perjalanan dengan baik. Terima kasih.</p>
                    ...
                    <div class="mt-12 pt-8 border-t border-line/50">
                        ...
                        <div class="bg-surface-container rounded-xl p-1 border border-line-strong focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary/20 transition-all">
                            <textarea class="w-full bg-transparent text-ink font-body-md p-3 outline-none resize-none placeholder:text-on-surface-variant/40" placeholder="Tulis balasan untuk Budi Santoso..." rows="5"></textarea>
